...
//!
//! Binds the UDP downlink socket and runs the current M1-M4 pipeline:
//! asynchronous ingest -> CCSDS telemetry parse -> tracking lookup -> physics co-validation.
//! Milestone 5 adds Open MCT WebSocket fan-out.
