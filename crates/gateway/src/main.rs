...
//!
//! Runs the current Milestone 1-4 pipeline demonstrator: UDP ingestion → CCSDS telemetry parsing
//! → station tracking → physics co-validation logging. Milestone 5 adds Open MCT WebSocket fan-out.
