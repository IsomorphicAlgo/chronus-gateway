...
//!
//! Runs the implemented M1-M4 demo pipeline:
//! UDP ingestion → CCSDS telemetry parsing → station tracking → Physics-Telemetry Co-Validation
//! logging. Open MCT WebSocket fan-out is the next distribution layer (M5).
