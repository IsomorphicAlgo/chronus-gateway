...
//!
//! Binds the UDP downlink socket and runs the current development pipeline:
//! ingest → CCSDS parse → station tracking → physics co-validation → structured logs.
//! Open MCT WebSocket fan-out remains Milestone 5.
