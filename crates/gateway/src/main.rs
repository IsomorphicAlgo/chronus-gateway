...
//!
//! Runs the M1-M4 demonstration pipeline: UDP ingest → CCSDS parse → station tracking →
//! physics validation → structured logs. Open MCT WebSocket fan-out is planned for M5.
