...
//!
//! Runs the current M1–M4 development pipeline: UDP ingestion, CCSDS parsing, station tracking,
//! and physics co-validation logging. Open MCT WebSocket fan-out remains Milestone 5.
