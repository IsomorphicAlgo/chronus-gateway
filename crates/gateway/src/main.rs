...
//!
//! Binds the UDP downlink socket and runs the current M1-M4 demo pipeline:
//! ingestion → CCSDS parse → station tracking → physics co-validation logging.
//! WebSocket / Open MCT fan-out remains Milestone 5.
