...
### M0 — Foundation
- [x] Binary smoke run produced a finite `TrackingState` (az/el/range/range-rate) from the ISS TLE;
      the binary has since grown into the M1-M4 ingest → parse → track → validate runtime.
