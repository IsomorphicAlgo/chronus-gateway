...
> Status: **M4 complete**. Ingestion, CCSDS parsing, station tracking, and Physics–Telemetry
> Co-Validation are implemented and tested. Open MCT WebSocket fan-out is the next milestone.
